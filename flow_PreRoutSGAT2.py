# @Time :4/24/2024 11:30 AM
# @Author :Pxmmmm
# @File :flow_PreRoutSGAT2.py
# @Version:  0.1
# @Conten: model 2
...
from PreRoutSGAT.PreRoutSGAT2 import PreRoutSGAT2
            ...
            for k, (g, ts) in data.items():
                ...
                print(
                    '{:.<12}: time {:.4f} r2_netdelay {:.4f}, r2_celldelay {:.4f}, r2_at {:.4f}, r2_slew {:.4f}, slack_f {:.4f}, slack_unf {:.4f}, slack_ep_f {:.4f}, slack_ep_unf {:.4f}'.format(
                        k,
                        time_t - time_s, r2_score_netdelay, r2_score_celldelay, r2_score_at, r2_score_slew,
