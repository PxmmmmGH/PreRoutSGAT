# @Time :4/27/2024 4:05 PM
# @Author :Pxmmmm
# @File :flow_PreRoutSGAT4.py
# @Version:  0.1
# @Conten: model 2 for ICCS
...
from PreRoutSGAT.PreRoutSGAT4 import PreRoutSGAT4
...
load_param_pretrain_path = False#10999
