# @Time :4/24/2024 9:10 PM
# @Author :Pxmmmm
# @File :PreRoutSGAT3.py
# @Version:  0.1
# @Content: base model2, add rat, fix a small problem of x3&net_delays at Top Model
...
class PreRoutSGAT3(torch.nn.Module):
    def __init__(self):
        super().__init__()
        ...
        self.prop = SignalProp(self.in_nf + self.nc_out, 12)
